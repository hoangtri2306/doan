...
const navItems = [
  ...
  { name: 'Kiểm duyệt', path: '/admin/moderation',
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
  },
  { name: 'Kháng cáo', path: '/admin/appeals',
        ...
        <div className="h-16 flex items-center px-4 gap-3" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          {sidebarOpen && (
            <Link href="/admin" className="hover:opacity-80 transition-opacity">
              <p className="text-white font-bold text-sm leading-tight">Bảng điều khiển</p>
          ...
          <div className="flex items-center gap-3">
            ...
            {sidebarOpen && (
              <div className="flex-1 min-w-0">
                ...
                <p className="text-violet-400 text-xs font-medium">Quản trị viên</p>
              </div>
            )}
            {sidebarOpen && (
